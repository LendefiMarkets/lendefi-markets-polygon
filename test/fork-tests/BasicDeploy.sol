...
contract BasicDeploy is Test {
    ...
    function deployMarketsWithUSD1() internal {
        ...
        // Deploy USD1 market
        // Skip USD1/USDC market deployment for Base network tests
    }
    ...
    function deployCompleteWithWETH() internal {
        ...
        // Deploy WETH market (18 decimal base asset) - Base mainnet WETH
        _deployMarket(0x4200000000000000000000000000000000000006, "Lendefi Yield Token WETH", "LYTWETH");
    }
